...
def load_flights_to_stg_dag():
    ...
    def create_stg_table():
        ...
        CREATE TABLE stg.flights (
            ...
            carrier_delay_min INTEGER DEFAULT 0,
            weather_delay_min INTEGER DEFAULT 0,
            nas_delay_min INTEGER DEFAULT 0,
            security_delay_min INTEGER DEFAULT 0,
            late_aircraft_delay_min INTEGER DEFAULT 0,
            wheels_off_tm integer,
            wheels_on_tm INTEGER,
            cancelled_flag boolean,
            cancellation_code TEXT DEFAULT 'Unknown',
